...
const cacheName = 'ExtraXpLevel7Pt1-2020-11-10 12:31:48.453174'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'ExtraXpLevel7Pt1'.length) === 'ExtraXpLevel7Pt1') {
